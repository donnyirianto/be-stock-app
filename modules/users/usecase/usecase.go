...
type UsersUsecase interface {
	...
	EditUsers(id int) (*utils.Response[map[string]any], error)
	SaveEditUsers(req *domain.RequestData, id int) (*utils.Response[map[string]any], error)
	DeleteUsers(id int) (*utils.Response[map[string]any], error)
}
